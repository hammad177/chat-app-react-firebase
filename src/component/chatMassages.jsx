          ...
          <>
            ...
            {this.props.messages === null ? (
              <div className='quick-chat'>
                <div />
                <p>No chat avilable. Try to Quick Chat Now...</p>
              </div>
            ) : (
              <div id='messages'>
                {get_messages.reverse().map((chat, index) => {
                  return (
                    <div
                      key={index}
                      className={`${
                        chat.uid === current_user.uid ? 'user-msg' : 'other-msg'
                      }`}>
                      <span className='span-msg'>
                        {chat.message}
                        <div className='msg-time'>{chat.time}</div>
                      </span>
                      ...
                      <IconContext.Provider
                        ...
                        <span className='delete-msg'>
                          <AiOutlineDelete
                            onClick={() =>
                              this.props.delete_message(messages_uid, chat.key)
                            }
                          />
                        </span>
                      </IconContext.Provider>
